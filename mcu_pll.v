...
/* Module Version: 5.7 */
/* /opt/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n mcu_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 24 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Tue May 30 22:43:03 2017 */


`timescale 1 ns / 1 ps
module mcu_pll (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
