...
/* Module Version: 5.7 */
/* /opt/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n mcu_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12 -fclkop 24 -fclkop_tol 0.0 -fclkos 10 -fclkos_tol 0.0 -fclkos2 8 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1  */
/* Mon Jun  5 17:40:35 2017 */
...
module mcu_pll (CLKI, CLKOP, CLKOS, CLKOS2)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.CLKOS2_CPHASE = 59 ;
    ...
    defparam PLLInst_0.CLKOS2_DIV = 60 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             ...
             /* synthesis FREQUENCY_PIN_CLKOS="10.000000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 10.000000
