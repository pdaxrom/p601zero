...
module mcu_rom (Address, OutClock, OutClockEn, Reset, Q)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam mem_0_4.initval = 256'hC8000888876183253ED0280E4FE00F307304F2116020B004050562335AF077FB ;
    ...
    defparam mem_0_2.initval = 256'hDF55555552B2AC5A8DA603F1FE23DC6AE6AE17ADA5C7D2B3F276F767FB5DB7DF ;
    ROM256X1A mem_0_2 (.AD7(Address[7]), .AD6(Address[6]), .AD5(Address[5]), 
        .AD4(Address[4]), .AD3(Address[3]), .AD2(Address[2]), .AD1(Address[1]), 
        .AD0(Address[0]), .DO0(mdL0_5_0));

    defparam mem_0_1.initval = 256'h113131111252961D4CC3C6076E649968E68E102181A3C204B76457F729ED9A6D ;
    ROM256X1A mem_0_1 (.AD7(Address[7]), .AD6(Address[6]), .AD5(Address[5]), 
        .AD4(Address[4]), .AD3(Address[3]), .AD2(Address[2]), .AD1(Address[1]), 
        .AD0(Address[0]), .DO0(mdL0_6_0));

    defparam mem_0_0.initval = 256'h4CECCCECC1A0AC9AA97F720BD503C33B31F29C8D0CEE83A33FAF8B21CA748104 ;
