...
module mcu_rom (Address, OutClock, OutClockEn, Reset, Q)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam mem_0_4.initval = 256'h55FCCCC0DA23181929F68140727F0079839827908B01058020282B119ED680A0 ;
    ...
    defparam mem_0_2.initval = 256'h77FDDD4C81B38D62D46D301F8FF11EE3573570BD6D2E3E959F93B5BB3FFAEC80 ;
    ROM256X1A mem_0_2 (.AD7(Address[7]), .AD6(Address[6]), .AD5(Address[5]), 
        .AD4(Address[4]), .AD3(Address[3]), .AD2(Address[2]), .AD1(Address[1]), 
        .AD0(Address[0]), .DO0(qdataout2_ffin));

    defparam mem_0_1.initval = 256'hFFFDD5C4CA7B9CB0EA661E303B7324CB473470810C0D1E1025BB21BFBB7FEC20 ;
    ROM256X1A mem_0_1 (.AD7(Address[7]), .AD6(Address[6]), .AD5(Address[5]), 
        .AD4(Address[4]), .AD3(Address[3]), .AD2(Address[2]), .AD1(Address[1]), 
        .AD0(Address[0]), .DO0(qdataout1_ffin));

    defparam mem_0_0.initval = 256'h55FC0019D6A90964D54BFB905EA81E19D98F94E46867741D19FD7F590A72A688 ;
