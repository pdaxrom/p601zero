...
UART_DATA	equ	$E6B0
UART_CONFIG	equ	$E6B1
UART_STATUS	equ	$E6B1
UART_PRESCALER	equ	$E6B2
...
PSEWD1  EQU  $18     pseudo command INT $XX /sashz
...
MNETABL EQU  *
        ...
        FCC  'INT '
        FCB  $3F
        FCB  PSEWD1      * Z/pdaXrom syscall pseudo op /sashz
        FCC  'TAB '
        FCB  $16
        FCB  INH
        FCC  'TAP '
...
;        CMPA #$3F
;        BEQ  DIS1       jump if int(swi) /sashz
...
DISPSEW1  EQU  *
        ...
        BNE  DISBTD
        TST  PNORM
        BEQ  DISPSEW11  jump if page1
        JSR  DISILLOP   "illegal opcode"
        RTS
DISPSEW11 JSR  PRNTMNE  output mnemonic
        JSR  DISDIR
        RTS
